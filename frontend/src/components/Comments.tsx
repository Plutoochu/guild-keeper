    ...
    return (
      <div className="bg-white/5 rounded-lg p-6">
        <div className="flex items-center justify-center py-8">
          ...
          <span className="ml-2 text-white">Učitavaju se komentari...</span>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-white/5 rounded-lg p-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <button
                  ...
                  className="bg-yellow-500 hover:bg-yellow-600 disabled:opacity-50 disabled:cursor-not-allowed text-black px-4 py-2 rounded-lg font-medium flex items-center transition-colors"
                >
                  {submitting ? (
                    <>
      ...
      {!user && !commentsLocked && (
        <div className="mb-6 p-4 bg-blue-500/20 border border-blue-500/30 rounded-lg">
          <p className="text-blue-200 text-center">
            <a href="/login" className="text-yellow-400 hover:underline">Prijavite se</a> da biste mogli komentirati.
          </p>
        </div>
      )}
      ...
      {commentsLocked && (
        <div className="mb-6 p-4 bg-red-500/20 border border-red-500/30 rounded-lg">
          <p className="text-red-200 text-center flex items-center justify-center">
      ...
      <div className="space-y-4">
        {comments.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-400">Nema komentara. Budite prvi koji će komentirati!</p>
          </div>
        ) : (
                  ...
                  {editingComment === comment._id ? (
                    <div className="space-y-2">
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-yellow-400 resize-none"
                        maxLength={1000}
                      />
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <button
                            ...
                            className="bg-yellow-500 hover:bg-yellow-600 disabled:opacity-50 text-black px-3 py-1 rounded font-medium transition-colors"
                          >
                            Spremi
                          </button>
                        </div>
                    ...
                    <p className="text-gray-300 whitespace-pre-wrap">{comment.tekst}</p>
                  )}
                </div>
              </div>
            </div>
